...
x = Reshape((-1, 128*80))(x)
print(x.shape)

x = Convolution1D(activation='relu', padding='valid', kernal_size=4, subsample_length = 1)(x)
...
### Test accuracy initial 0.83892########
### 64 Relu 0.82312 #################
### 64 Relu -> Dropout (0.5) 0.809 #####
